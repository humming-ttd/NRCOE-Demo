  ...
  var _componentSweetAlert = function () {
          ...
          preConfirm: function (login) {
            return fetch("https://api.github.com/users/" + login)
              ...
              .catch(function (error) {
                swalInit.showValidationMessage("Request failed: " + error);
              });
          },
    ...
    $("#sweet_bg").on("click", function () {
      swalInit.fire({
        ...
        background:
          "#fff url(../../../../global_assets/images/backgrounds/boxed_bg_retina.png) repeat",
      });
    });
      ...
      swal
        ...
        .then(function (result) {
          if (result.value) {
            swalInit.fire({
              title: "All done!",
              html: 'Your answers: <pre class="mt-3">' + JSON.stringify(result.value) + "</pre>",
    ...
    $("#sweet_combine").on("click", function () {
      swalInit
        .fire({
          title: "Is on-site audit required ?",
          text: "You won't be able to revert this!",
          type: "warning",
          showCancelButton: true,
          confirmButtonText: "Yes, proceed submission!",
        ...
        .then(function (result) {
          if (result.value) {
            swalInit.fire("Submitted!", "", "success");
          } else if (result.dismiss === swal.DismissReason.cancel) {
            swalInit.fire("Cancelled", "", "error");
          }
        });
    });
    ...
    $("#sweet_multiselect").on("click", function () {
      swalInit
        .fire({
          ...
          inputValidator: function (value) {
            return (
              !$(".swal2-select.select-multiselect").val().length && "You need to select something!"
            );
          },
          inputAttributes: {
            multiple: "multiple",
        ...
        .then(function (result) {
          ...
          if (result.dismiss === swal.DismissReason.cancel) {
            swalInit.fire("Cancelled", "You are safe now", "error");
          }
        });
    });
  };
