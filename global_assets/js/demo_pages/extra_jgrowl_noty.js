...
var NotyJgrowl = (function () {
  ...
  var _componentJgrowl = function () {
    ...
    $("#jgrowl-styled-left").on("click", function () {
      $.jGrowl("Thank you for your submssion ", {
        header: "Succesfully Submitted !",
        theme: "alert-bordered alert-styled-left alert-success",
      });
    });

    // Styled left
    $("#jgrowl-styled-audit-trigger").on("click", function () {
      $.jGrowl("Audit notifcation sent to ICP Recipient", {
    ...
    // Styled left(accept)
    $("#jgrowl-styled-left-accept").on("click", function () {
      $.jGrowl("The approval has been sent", {
        header: "Succesfully Accepted !",
        theme: "alert-bordered alert-styled-left alert-success",
      });
    });
