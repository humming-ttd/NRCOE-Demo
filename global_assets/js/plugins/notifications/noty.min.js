...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function l(t, e) {
        var n = f(t),
          o = void 0;
        a(t, e) &&
          ((o = n.replace(" " + e + " ", " ")), (t.className = o.substring(1, o.length - 1)));
      }
      function d(t) {
    ...
    function (t, e, n) {
      ...
      function i(t) {
        E.hasOwnProperty(t.options.queue) || (E[t.options.queue] = { maxVisible: x, queue: [] }),
      ...
      function c(t) {
        ...
        (t.barDom = document.createElement("div")),
          ...
          k.addClass(
            t.barDom,
            "noty_bar noty_type__" + t.options.type + " noty_theme__" + t.options.theme
          ),
      ...
      function y(t) {
        t.options.timeout &&
          ...
          t.options.progressBar &&
            t.progressDom &&
            k.css(t.progressDom, { transition: "width 0ms linear", width: "100%" }));
      }
      function b(t, e) {
    ...
    function (t, e, n) {
      ...
      e.Push = (function () {
        function t() {
          var e =
            arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "/service-worker.js";
          return (
            o(this, t),
            (this.subData = {}),
            (this.workerPath = e),
                ...
                if (window.Notification && window.Notification.permissionLevel)
                  ...
                  window.Notification && window.Notification.permission
                    ...
                    : window.external &&
                      ...
                      (t = window.external.msIsSiteMode() ? "granted" : "default");
                  ...
                  i = function (o) {
                    "granted" === o
                      ? (t.fire("onPermissionGranted"),
                        "serviceWorker" in navigator
                          ? navigator.serviceWorker.register(t.workerPath).then(function () {
                      ...
                      : "denied" === o && (t.fire("onPermissionDenied"), t.unregisterWorker());
                  };
                "default" === o
    ...
    function (t, e, n) {
      (function (e, o) {
        ...
        !(function (e, n) {
          ...
          function w(t, e, n) {
            e.constructor === t.constructor && n === l && e.constructor.resolve === d
              ? b(t, e)
              : n === it
          ...
          function k(t, e) {
            t._state === et &&
              ((t._result = e), (t._state = nt), 0 !== t._subscribers.length && U(D, t));
          }
          function C(t, e) {
          ...
          function P(t, e, n, o) {
            ...
            if (r) {
              if (
                ((s = E(n, o)),
                s === rt ? ((c = !0), (u = s.error), (s.error = null)) : (a = !0),
                e === s)
              )
                return void C(e, p());
            } else (s = o), (a = !0);
            e._state !== et ||
              (r && a ? g(e, s) : c ? C(e, u) : t === nt ? k(e, s) : t === ot && C(e, s));
          }
          function T(t, e) {
            try {
              e(
          ...
          function V(t) {
            (this[tt] = O()),
              ...
              (this._subscribers = []),
              f !== t && ("function" != typeof t && H(), this instanceof V ? T(this, t) : W());
          }
          function B() {
            var t = void 0;
            if (void 0 !== o) t = o;
              ...
              [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    !0 === this.options.killer
                      ? t.closeAll()
                      : "string" == typeof this.options.killer && t.closeAll(this.options.killer);
                    ...
                    if (
                      ...
                      return (
                        ...
                        d.PageHidden &&
                          this.hasSound &&
                          c.inArray("docHidden", this.options.sounds.conditions) &&
                          c.createAudioElements(this),
                        d.PageHidden &&
                          c.inArray("docHidden", this.options.titleCount.conditions) &&
                    ...
                    if (
                      ...
                      this.hasSound &&
                        !this.soundPlayed &&
                        c.inArray("docVisible", this.options.sounds.conditions) &&
                        c.createAudioElements(this),
                      c.inArray("docVisible", this.options.titleCount.conditions) &&
                        d.docTitle.increment(),
                      (this.shown = !0),
                      (this.closed = !1),
                      d.hasButtons(this) &&
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return (
                      this.barDom && (this.barDom.querySelector(".noty_body").innerHTML = t),
                    ...
                    return this.closed
                      ...
                      ? (d.fire(this, "onClose"),
                        ...
                        null === this.options.animation.close
                          ...
                          : (c.addClass(this.barDom, this.options.animation.close),
              ...
              [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return (
                      d.Queues.hasOwnProperty(e) || (d.Queues[e] = { maxVisible: t, queue: [] }),
