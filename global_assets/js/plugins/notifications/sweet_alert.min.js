!(function (t, e) {
  ...
  function X() {
    var t = m(R().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(
        function (t, e) {
          return (
  ...
  var it,
    ...
    ct = '\n <div aria-labelledby="'
      ...
      .concat(x.actions, '">\n     <button type="button" class="')
      .concat(x.confirm, '">Submit</button>\n     <button type="button" class="')
  ...
  function mt(t, e) {
    ...
    n &&
      ...
      (function (t, e) {
        e in x
          ? rt(t, x[e])
          : (w('The "position" parameter is not valid, defaulting to "center"'), rt(t, x.center));
      })(n, e.position),
      (function (t, e) {
  ...
  function Pt(t, e) {
    !(function (t, e) {
      ...
      T(n, "width", e.width),
        ...
        (n.className = x.popup),
        e.toast
          ? (rt([document.documentElement, document.body], x["toast-shown"]), rt(n, x.toast))
          : rt(n, x.modal),
  ...
  var de = function (t, e) {
      pt && H(e)
        ? ((t.style.overflowY = "hidden"), e.addEventListener(pt, ne.bind(null, e, t)))
    ...
    pe = function (t, e) {
      !(function () {
        ...
        "undefined" != typeof window && Ft() && (_t(), window.addEventListener("resize", _t)),
        m(document.body.children).forEach(function (t) {
          t === j() ||
            (function (t, e) {
